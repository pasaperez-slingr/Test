...
public class Api extends HttpEndpoint {
    ...
    @EndpointDataStore(name = "googleAccessToken")
    ...
    public void endpointStarted() {
        try {
            ...
            try {
                ...
                appLogs.error("An error occurred while generating the private key ", e);
            }
            ...
            accessTokenDS.removeById(LAST_TOKEN);
            setAccessToken();
    ...
    public void setAccessToken() {
        ...
        try {
            ...
            Json newToken = Json.map()
                    ...
                    .set(ID, LAST_TOKEN);
            this.accessTokenDS.save(newToken);
